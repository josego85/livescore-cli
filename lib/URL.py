URL = {
    'bpl': ["Barclay's Premier League",\
            'http://www.livescores.com/soccer/england/premier-league/',\
            'http://www.bbc.com/sport/football/premier-league/top-scorers'],

    'laliga': ["La Liga BBVA",\
               'http://www.livescores.com/soccer/spain/primera-division/',\
               'http://www.bbc.com/sport/football/spanish-la-liga/top-scorers'],

    'bundesliga': ["German Bundesliga",\
                   'http://www.livescores.com/soccer/germany/bundesliga/',\
                   'http://www.bbc.co.uk/sport/football/german-bundesliga/top-scorers'],

    'seriea': ["Italian Serie A",\
               'http://www.livescores.com/soccer/italy/serie-a/',\
               'http://www.bbc.co.uk/sport/football/italian-serie-a/top-scorers'],

    'ligue1': ["French Lige 1",\
               'http://www.livescores.com/soccer/france/ligue-1/',\
               'http://www.bbc.co.uk/sport/football/french-ligue-one/top-scorers'],
...
goal_us = 'http://www.goal.com/en-us/feeds/news?fmt=smj'
